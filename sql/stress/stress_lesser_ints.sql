...
--      :tertiary_lanes -> assumed number of lanes for tertiary roads (only 1/2 the road)
----------------------------------------
UPDATE neighborhood_ways SET ft_int_stress = 1, tf_int_stress = 1
WHERE
    functional_class IN ('residential', 'unclassified', 'living_street', 'track', 'path');
                ...
                WHEN w.functional_class = 'primary' AND w.one_way IS NULL
                    THEN CASE
                        ...
                        WHEN
                            ...
                            THEN CASE
                                WHEN
                                    COALESCE(w.speed_limit,: primary_speed) > 30
                                    THEN TRUE
                                WHEN
                                    COALESCE(w.speed_limit,: primary_speed) = 30
                                    THEN NOT COALESCE(i.island, FALSE)
                ...
                WHEN w.functional_class = 'secondary' AND w.one_way IS NULL
                    THEN CASE
                        ...
                        WHEN
                            ...
                            THEN CASE
                                WHEN
                                    COALESCE(w.speed_limit,: secondary_speed)
                                    > 30
                                    THEN TRUE
                                WHEN
                                    COALESCE(w.speed_limit,: secondary_speed)
